...
st.subheader("Prediciton of Closing Price")
...
if display_option == "2nd Algo":
    ...
    st.write(f'{two_days_ago} Closing price was :  {close_value}')
    try:
        if df1.empty:
            st.write("Stock Market is not closed yet....")
        else:
